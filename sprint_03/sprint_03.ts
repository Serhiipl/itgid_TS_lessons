...
let s_1: string;
function f01(): void {
  let input = document.querySelector(".i-1") as HTMLInputElement;
...
let res_2: number;
function f02(): void {
  let input = <HTMLInputElement>document.querySelector(".i-2");
  if (input) {
    res_2 = +input.value;
  }
  console.log(res_2);
...
let min_4: number;
function f04(): void {
  let i41 = <HTMLInputElement>document.querySelector(".i-41");
  let i42 = <HTMLInputElement>document.querySelector(".i-42");
...
function f05(): void {
  let i51 = <HTMLInputElement>document.querySelector(".i-51");
  let i52 = <HTMLInputElement>document.querySelector(".i-52");
...
let error_6: boolean;
function f06(): void {
  let i61 = document.querySelector(".i-61") as HTMLInputElement;
  let i62 = document.querySelector(".i-62") as HTMLInputElement;
...
let max_7: string;
function f07(): void {
  let i71 = document.querySelector(".i-71") as HTMLInputElement;
  let i72 = document.querySelector(".i-72") as HTMLInputElement;
...
function f08(): void {
  let v8 = <HTMLInputElement>document.querySelector(".s-8");
  val_8 = v8.value;
...
const val_9: string = "5";

function f09(): void {
  let select = <HTMLInputElement>document.querySelector(".s-9");
  select.value = val_9;
...
function f10(): void {
  const chBox = document.querySelector(".ch-10") as HTMLInputElement;
...
function f11(): void {
  const checkbox = <HTMLInputElement>document.querySelector(".ch-11");
...
function f12(): void {
  const checkB = <HTMLInputElement>document.querySelector(".ch-12");
...
function f13(): void {
  let val: string = "";
  let inp = <HTMLInputElement>document.querySelector(".i-13");
...
function f14(): void {
  let inp = <HTMLInputElement>document.querySelector(".i-14");
  if (+inp.value % 2 === 0) {
    res_14 = true;
  } else {
    res_14 = false;
...
function f16(): void {
  let inp = <HTMLInputElement>document.querySelector(".i-16");
...
function f17(): void {
  let input = document.querySelector(".i-17") as HTMLInputElement;
...
let s_20: number = 0;
let input = document.querySelector(".i-20") as HTMLInputElement;
