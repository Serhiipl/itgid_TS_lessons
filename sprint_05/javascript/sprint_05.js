...
const f02 = (a) => a.toLowerCase().trim();
...
const f06 = () => {
    let inp1 = document.querySelector(".i-61");
    let inp2 = document.querySelector(".i-62");
    let bigestVal = inp1.value > inp2.value ? inp1.value : inp2.value;
...
const f10 = () => {
    angle += 30;
    (document.querySelector(".out-10")).style.transform = `rotate(${angle}deg)`;
};
