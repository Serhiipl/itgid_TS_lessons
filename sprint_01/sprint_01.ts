...
const s_031: string = "uno";
const s_032: string = " pomidorro";
...
let n_13;
let s_13;
let inputItem = document.querySelector(".p-13").innerHTML;
isNaN(parseInt(inputItem)) ? (s_13 = inputItem) : (n_13 = inputItem);
console.log(n_13);
console.log(s_13);
// Task 14
...
let b_20: boolean = Boolean(+document.querySelector(".p-20").innerHTML);
console.log(b_20);
